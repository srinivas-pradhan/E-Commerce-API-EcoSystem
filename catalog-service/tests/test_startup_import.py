...
class StartupImportTest(unittest.TestCase):
    def test_start_script_exports_local_env_file(self):
        ...
        start_script = service_dir / "start-catalog-service.sh"
    ...
    def test_main_imports_when_loaded_from_repo_root(self):
        ...
        code = (
            ...
            "spec = importlib.util.spec_from_file_location('catalog_service_main', 'catalog-service/main.py'); "
        ...
        self.assertEqual(result.stdout.strip(), "Product Catalog Service")
